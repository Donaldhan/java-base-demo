 ...
 * 所以Field并没有实现GenericDeclaration接口！{@link GenericDeclarationTest4}
 * @author donald
 * 2017年7月29日
 * 上午11:25:59
 */
public class GenericDeclarationTest2 {
	/**
	 * 在Class上定义泛型，直接在构造方法上定义泛型;
	 * @param t
	 */
	public <T> GenericDeclarationTest2(T t){
