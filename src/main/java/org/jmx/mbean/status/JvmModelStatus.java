 ...
 * 上午9:00:47
 */
public class JvmModelStatus implements ModelMBean {
	private static Logger log = LoggerFactory.getLogger(JvmModelStatus.class);
	private Long memerySize;
	private Integer coreCpuProssors;
	private String applicationName;
	private String statusInfo;
	public JvmModelStatus(String applicationName) {
		super();
